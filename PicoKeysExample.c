/*
 * demo for usb keyboard
 * modified from https://github.com/PhilboBaggins/pico-keys
 * 
 * 5 buttons connected to waveshare rp2040 zero
 * 5 buttons from shopee circuitrocks
 * 
 * connections:
 * 
 * rp2040      5 button
